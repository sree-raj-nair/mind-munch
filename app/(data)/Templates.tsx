export default  [
    {
        ...
        aiPrompt:'Craft a comprehensive list of 5 engaging and unique blog topic ideas within the [specific niche] industry, focusing on [outline topic]. For each topic, provide a brief yet compelling description that highlights its relevance and potential value to the target audience. Consider current trends, common pain points, and emerging issues in the field to ensure the topics are timely and interesting. Additionally, incorporate a mix of informative, how-to, and thought-provoking concepts to cater to various reader preferences. Present the results in a clear, visually appealing format using rich text editor features such as bold headings, italicized descriptions, and bullet points for easy readability. Aim to inspire creativity and offer practical value to both the blog writer and the intended audience.',
